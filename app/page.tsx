    ...
    <div className="dashboardPanel">
      <div className="topNavigation">
        <ul>
           {colors.map(color => (
            <li key={color.name}>
            <Link href={`/${color.name}`}>{color.name}</Link>
            </li>
            ))}
        </ul>
      </div>
      <div className="flexRow">
        <div className="sideBar">
            ...
            <h5 className="borderBottom"><FontAwesomeIcon icon={faHandPointDown}  style={{"width": "20px", "float": "left", "height": "15px", "marginTop": "7px"}} />  Solution Tree</h5>
            </div>            
            </div>
            <div className="workspaceGraphic"></div>
            <div style={{"marginLeft":"20px", "marginRight":"20px"}}>                 
            <SimpleTreeView>             
              <TreeItem id="grid" itemId="grid" label="Workspaces">
              ...
              <TreeItem id="pickers" itemId="pickers" label="Integration">
                <div className="flexRow flexStart">
              ...
              <TreeItem id="charts" itemId="charts" label="Branches">
                <div className="flexRow flexStart">
        ...
        <div className="contentBar">
          <div style={{padding:"10px 10px 15px 20px"}}>
            <h5 className="borderBottom" style={{"paddingTop":"10px"}}> 
              <FontAwesomeIcon icon={faChartBar}  style={{"width": "20px", "float": "left", "height": "15px", "marginTop": "7px"}} /> Graphs
            </h5>
            <p className="textInfo" style={{"paddingTop":"10px"}}>
          ...
          <div style={{padding:"10px 10px 15px 20px"}}>
            <h5 className="borderBottom" > 
              <FontAwesomeIcon icon={faCode}  style={{"width": "20px", "float": "left", "height": "15px", "marginTop": "7px"}} /> Code
            </h5>
            <p className="textInfo" style={{"paddingTop":"10px"}}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit... 
            </p>
            <p style={{"fontSize":"12px"}}>
              <textarea className="codeEditor" readOnly
                value="<!DOCTYPE html>
<html>
<body>
...
function Header({}){
  return <div className="appHeader flexRow">
    ...
    <div className="iconButtons">
      ...
      <button className="btn"><FontAwesomeIcon icon={faQuestion} /></button>
...
export default function Home() {
  ...
  return (
    <div className="main">
      <Header />
      <div className="flexRow">
        <LeftPanel key="leftPanel"></LeftPanel>
        <MainPanel key="mainPanel"></MainPanel>
      </div>
    </div>
  );
